 ...
 */
export const CARTESIA_TTS_SYSTEM_PROMPT = `
...
// 3. **Emotions**: Use <emotion value="X"/> tags to guide the emotional tone of what follows. The emotion must match the content - conflicting emotions and text will not work well. Place the tag before the text you want affected.
